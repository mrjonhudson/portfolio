    ...
    return (
        <div className="
            ...
            <div className='w-full'>
                <Image className='w-full justify-center' src='./img/title.svg' alt='mrjonhudson portfolio' width={1147} height={208} />
            </div>
            <div className='flex-grow flex flex-col'>
                <div className='screenDisplay flex-grow flex-col lg:flex-row flex' style={{ flex: 1, justifyContent: 'center', alignItems: 'center', gap: 60 }}>
                    <p className='text-2xl text-[var(--snow)] justify-center flex'>
                        I research, design and build
                    </p>
                    <p className='text-2xl lg:text-3xl text-[var(--snow)]'>
                        Apps
                        <br></br>
                        Websites
                        <br></br>
